...
- NO TEXT OR LETTERS: DO NOT DRAW ANY WORDS, LETTERS, NUMBERS, LOGOS, LABELS, LICENSE PLATES, OR SIGNAGE. If a real scene contains signs or text, render them as blank shapes without characters.
