...
export async function POST(request: NextRequest) {
  try {
    console.log('🔍 FIXED PAYMENT API - Starting payment session creation');
    ...
    console.log('🔍 FIXED PAYMENT API - Request data:', { amount, currency, packageId, credits, userId });
    ...
    console.log('🔍 FIXED PAYMENT API - Generated order ID:', orderId);
    ...
    console.log('🔍 FIXED PAYMENT API - Creating payment session...');
    const paymentResult = await createPaymentSession(paymentData);

    console.log('🔍 FIXED PAYMENT API - Payment result:', paymentResult);
    ...
    console.error('Fixed payment session creation error:', error);
    return NextResponse.json(
      { 
